...
special_tiles_file_name="_solo_wwf_special_tiles.csv"
saved_games_dir="solo_games"
possible_cols = "abcdefghijk"
row_length = 11
bingo_bonus = 35
...
def getTemplateFilePath():
    return os.path.join(os.getcwd(), config_dir, "_solo_template.csv")
...
def printBoard(board):
    header_row = list(string.ascii_lowercase)[:11]
    header_row.insert(0, "")
